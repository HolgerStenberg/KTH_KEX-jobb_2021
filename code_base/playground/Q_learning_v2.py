...
sys.path.append('../')
from warehouse_environments.default_warehouses import default_warehouse_DQN_2, default_warehouse_1
...
def main():
	...
	with open('LOGGED_Q_v2'+'.csv', mode='w') as the_file:
